...
if __name__ == "__main__":
    ...
    parser.add_argument("--past_time", type=float, default=0.05-0.0025)  # s :0.0475
    ...
    parser.add_argument("--x_model", type=str,
                        default="/home/ssx/shengshuxuan/DIDO/Vel/train_output/checkpoints/checkpoint_latest.pt")
